...
public class MainObjetosArray {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------");
		mostrasPuntuacion(r2.puntuaciones[2]);
		mostrasPuntuacion(r3.puntuaciones[2]);
		mostrasPuntuacion(r4.puntuaciones[2]);
		
	}
	
	public static void mostrasPuntuacion(double p) {
